\documentclass[handout,a4paper,t,xcolor=pst,dvips]{beamer}
...
%\begin{frame}[c]
%	\frametitle{Regla Fundamental del Trabajo Eficaz en Equipo}
%	\begin{itemize}[<+->]
%		\item Identificar las tareas a realizar.
%		\item Tratar de hacer cada tarea realizable de manera autónoma.
%		\item Coordinar el progreso de las tareas. 
%		\item Tratar de reducir los esfuerzos de coordinación al mínimo.
%	\end{itemize}
%\end{frame}
